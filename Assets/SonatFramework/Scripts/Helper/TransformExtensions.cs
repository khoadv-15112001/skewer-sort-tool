...
// code by github.com/adammyhre

namespace Sonat_Screw_Jam
{
    public static class TransformExtensions
    {
        ...
        public static void SetSizeDeltaX(this Image img, float x)
        {
            img.rectTransform.sizeDelta = new Vector2(x, img.rectTransform.sizeDelta.y);
        }
