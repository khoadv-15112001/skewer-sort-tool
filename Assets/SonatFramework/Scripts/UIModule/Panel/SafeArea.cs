...
namespace SonatFramework.Scripts.UIModule
{
    ...
    {
        [SerializeField] private bool ConformX; // Conform to screen safe area on X-axis (default true, disable to ignore)

        [SerializeField] private bool ConformY = true; // Conform to screen safe area on Y-axis (default true, disable to ignore)

        [SerializeField] private float topIg = 0;
...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        private void ApplySafeArea(Rect r)
        {
            ...
            if (Screen.width > 0 && Screen.height > 0)
            {
                ...
                anchorMax.y += (1 - anchorMax.y) * topIg;
